...
class TestGeminiNativeThinkingClientInit:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (LLMProviderType.OPENAI, "OPENAI_API_KEY", "requires Google provider, got openai"),
...
class TestGeminiNativeThinkingClientGenerate:
    ...
    def sample_conversation(self) -> LLMConversation:
        """Create a sample conversation for testing."""
        return LLMConversation(messages=[
            LLMMessage(role=MessageRole.SYSTEM, content="You are an SRE assistant."),
